...
namespace BlossomServer.Infrastructure.Migrations
{
    ...
    [Migration("20250628033003_Update-Booking-Guest")]
    partial class UpdateBookingGuest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlossomServer.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOfBirth = new DateOnly(2025, 6, 28),
                            Email = "admin@gmail.com",
                            FirstName = "Admin",
                            Gender = 0,
                            LastName = "Super",
                            Password = "$2a$11$I2Z4AvfP.w0rvsxQtw5Y2uMdJAcfZerPW7ztvPxGEXfxdKcCIMk2S",
